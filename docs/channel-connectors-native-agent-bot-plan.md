...
> 状态：已切换为 Studio 原生实现路线；F4 thread/reply slice completed
> 更新：2026-06-06
...
| F4 | 进行中：长回复拆分、Feishu thread/reply session 隔离已完成；继续补图片/文件、语音、群聊 mention、history context、长回复预览冻结、流式预览 |
