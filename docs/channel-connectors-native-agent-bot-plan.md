...
| F4 | 进行中：长回复拆分、Feishu thread/reply session、附件 metadata/staging、轻量 history context 已完成；继续补语音 STT/TTS、群聊 mention、长回复预览冻结、流式预览 |
...
1. F4：补群聊成员、长回复 group buffer 和治理策略。
