...
> 状态：Phase C deletion completed; Phase B core matrix completed; Phase D provider routing/model catalog/active-route smoke MVP added; Phase E app connection profile/rollback MVP added; Phase B2 maturity hardening remains open
> 更新：2026-06-05
...
| Phase E | Codex、Claude Code、OpenCode、OpenClaw 配置 preview/apply/profile/rollback MVP 已完成；继续做真实客户端配置 apply 验收和细节兼容 |
