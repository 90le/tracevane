...
| [archive/m8-c-rc-quick-gate-summary.md](./archive/m8-c-rc-quick-gate-summary.md) | M8-C RC quick gate execution and blocker triage，稳定 quick matrix 的端口、BASE_URL、Vite smoke cache/watch 与失败残留清理，下一步进入 M8-D full/domain RC matrix |
