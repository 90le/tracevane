...
| [archive/m8-b-rc-smoke-matrix-runner-summary.md](./archive/m8-b-rc-smoke-matrix-runner-summary.md) | M8-B RC smoke matrix runner / documentation cleanup foundation，新增 `ide:rc:*` 本地矩阵 runner、npm 入口与文档状态收口，下一步进入 M8-C RC 执行与 blocker triage |
