...
- Historical execution logs are intentionally omitted from the public repository.
...
- Do not reintroduce phase logs, cleanup progress files, or generated acceptance snapshots.
...
- Visual/theme guidance must point to `14`, `docs/界面设计守则.md`, and `apps/web/src/design/theme.css`.
