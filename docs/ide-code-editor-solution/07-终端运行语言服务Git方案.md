...
M7.z-C：LSP rename / formatting / code actions plan（下一步）。
```
...
35. M7.z-C：LSP rename / formatting / code actions plan（下一步）
```
