...
> 更新：2026-06-17
> 文档规则：本文件只保留目标、边界、验收和阶段计划；当前进度写到 `网关进度.md`。
...
- 新协议、SDK、provider、媒体或 Realtime/WebSocket 能力必须先按 `docs/研究先行开发清单.md` 完成官方/API/SDK/GitHub/社区核验，再落到 adapter 和测试；无法验证的组合返回结构化 unsupported。
...
GPT / ChatGPT / Codex 账户接入是 Gateway 下一阶段目标，参考 `docs/网关账户型Provider方案.md`。
...
- 核验结论、拒绝方案、风险和验证计划写入 `docs/研究先行开发清单.md`、本文件、`网关进度.md` 或专项 tracker。
