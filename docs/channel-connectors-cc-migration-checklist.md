...
- `node --test --test-name-pattern "native Channel Connectors process runner" tests/system/channel-connectors-service.test.mjs`，20/20 通过，覆盖 Codex one-shot `Working` 心跳续期、静默 heartbeat timeout、Codex/Claude/OpenCode 工具流和权限处理。
