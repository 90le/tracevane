...
2. 先做真实 IM live approval smoke：用新增 agent-run-live permission flags 验证 Feishu/Octo 审批 prompt、resolved decision、Feishu 进度卡状态，再扩展真实 Claude/OpenCode 视觉输入和 IM live 文件上传 smoke。
