...
- 下一步：先修正 Octo 群聊最近上下文、成员能力提示、私聊和 @ 语义，并做 `studio-channel-messages` 私聊/@群成员 live smoke；继续按 Octo 插件迁移 GROUP.md/thread MD/persona context、delete-thread 和菜单；随后按同一模式补 Feishu open_id/user_id 私聊、富文本、文档/云盘 skills 和更多平台 adapter。
