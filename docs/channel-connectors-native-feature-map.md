...
- 下一步：先做 `studio-channel-messages` Octo human DM、群/thread @成员和 @其它 Studio/外部 bot live smoke；继续按 Octo 插件迁移 persona/OBO 和更完整菜单；随后按同一模式补 Feishu open_id/user_id 私聊、富文本、文档/云盘 skills 和更多平台 adapter。
