<template>
  <section class="channel-provider-overview">
    <article class="channel-provider-strip">
      <section class="channel-provider-strip__main">
        ...
        <div class="channel-provider-facts" :aria-label="text('频道摘要', 'Provider summary')">
          <div class="channel-provider-fact">
      ...
      <aside class="channel-provider-strip__edit" :aria-label="text('高频快改', 'High-frequency quick edits')">
        <div class="channel-provider-edit-head">
        ...
        <div class="channel-provider-overview__quick-grid">
          <label class="option-row channel-provider-toggle">
