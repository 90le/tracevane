...
type DashboardQuickActionKey = 'chat' | 'agents' | 'config' | 'cron' | 'dreaming' | 'system';
...
const dashboardQuickActionRecipes: Record<DashboardQuickActionKey, DashboardQuickActionRecipe> = {
  chat: {
    labelZh: '进入私聊入口',
  ...
  dreaming: {
    ...
    copyEn: 'Inspect memory slot selection, the dreaming toggle, and the Dream Diary.',
  },
  system: {
    labelZh: '打开系统诊断',
