...
export type ShellNavItem = {
  key: string;
  to: string;
  icon: 'dashboard' | 'agents' | 'dreaming' | 'chat' | 'channels' | 'cron' | 'skills' | 'terminal' | 'config' | 'system';
  labelZh: string;
  labelEn: string;
  future?: boolean;
};
...
export const shellNavGroups: ShellNavGroup[] = [
  {
    ...
    titleEn: 'Overview',
    items: [
      { key: 'dashboard', to: '/dashboard', icon: 'dashboard', labelZh: '仪表盘', labelEn: 'Dashboard' },
      { key: 'chat', to: '/chat', icon: 'chat', labelZh: '会话工作台', labelEn: 'Chat' },
      { key: 'room', to: '/room', icon: 'chat', labelZh: '协作空间', labelEn: 'Room', future: true },
      { key: 'workflow', to: '/workflow', icon: 'chat', labelZh: '工作流', labelEn: 'Workflow', future: true },
    ],
  },
  {
    key: 'operations',
    ...
    titleEn: 'Operations',
    items: [
      { key: 'skills', to: '/skills', icon: 'skills', labelZh: '技能管理', labelEn: 'Skills' },
      { key: 'terminal', to: '/terminal', icon: 'terminal', labelZh: '维护终端', labelEn: 'Terminal' },
      { key: 'system', to: '/system', icon: 'system', labelZh: '系统诊断', labelEn: 'System' },
    ],
  },
  {
    key: 'management',
    ...
    titleEn: 'Management',
    items: [
      { key: 'agents', to: '/agents', icon: 'agents', labelZh: 'Agent 管理', labelEn: 'Agents' },
      { key: 'channels', to: '/channels', icon: 'channels', labelZh: '频道管理', labelEn: 'Channels' },
      { key: 'cron', to: '/cron', icon: 'cron', labelZh: '定时任务', labelEn: 'Cron' },
      { key: 'config', to: '/config', icon: 'config', labelZh: '系统配置', labelEn: 'Config' },
    ],
  },
  {
    key: 'system',
    ...
    titleEn: 'System',
    items: [
      { key: 'dreaming', to: '/dreaming', icon: 'dreaming', labelZh: '梦境记忆', labelEn: 'Dreaming' },
    ],
  },
];
