...
export function repairSystemBootstrapConfig(): Promise<SystemBootstrapRepairResponse> {
  return requestJson<SystemBootstrapRepairResponse>('/api/system/bootstrap/repair', {
    method: 'POST',
  });
}
...
export function fetchStudioUpgradeStatus(): Promise<SystemStudioUpgradeStatusPayload> {
  return requestJson<SystemStudioUpgradeStatusPayload>('/api/system/studio-upgrade');
}

export function startStudioUpgrade(payload: SystemStudioUpgradeRequest = {}): Promise<SystemStudioUpgradeResponse> {
  return requestJson<SystemStudioUpgradeResponse>('/api/system/studio-upgrade', {
    method: 'POST',
    headers: {
...
export function approveSystemDeviceTrust(
  ...
  return requestJson<SystemDeviceTrustApproveResponse>('/api/system/device-trust/approve', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export function repairSystemDeviceTrustHelper(): Promise<SystemDeviceTrustRepairResponse> {
  return requestJson<SystemDeviceTrustRepairResponse>('/api/system/device-trust/repair-helper', {
    method: 'POST',
  });
}
...
export function patchSystemDeviceTrustSettings(
  ...
  return requestJson<SystemDeviceTrustSettingsPatchResponse>('/api/system/device-trust/settings', {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json',
    },
