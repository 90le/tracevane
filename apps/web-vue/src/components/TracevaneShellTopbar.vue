<template>
  <header class="tracevane-shell-topbar" role="banner">
    <button
      v-if="isMobile"
      type="button"
    ...
    >
      <Menu class="tracevane-shell-topbar__icon" aria-hidden="true" />
    </button>

    <div class="tracevane-shell-topbar__identity" :aria-label="routeIdentityLabel" aria-live="polite">
      <span class="tracevane-shell-topbar__route-label">{{ currentGroupTitle }}</span>
      <code class="tracevane-shell-topbar__path-label">{{ currentPathLabel }}</code>
    </div>

    <div class="tracevane-shell-topbar__controls">
