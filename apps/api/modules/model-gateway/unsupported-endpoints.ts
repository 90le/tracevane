...
const OPENAI_UNSUPPORTED_ENDPOINTS: ModelGatewayUnsupportedEndpointDefinition[] = [
  ...
  },
  {
    ...
    reason: OPENAI_ENDPOINT_UNSUPPORTED_REASON,
    httpRoutes: [
      { method: "GET", path: "/v1/fine-tuning/jobs", endpoint: "/v1/fine-tuning/jobs" },
      { method: "POST", path: "/v1/fine-tuning/jobs", endpoint: "/v1/fine-tuning/jobs" },
    ],
  },
  {
    method: "GET",
    path: "/v1/fine-tuning/jobs/{job_id}",
    endpoint: "/v1/fine-tuning/jobs/{job_id}",
    code: MODEL_GATEWAY_ENDPOINT_UNSUPPORTED_CODE,
    reason: OPENAI_ENDPOINT_UNSUPPORTED_REASON,
    httpRoutes: [{ method: "GET", path: "/v1/fine-tuning/jobs/:jobId", endpoint: "/v1/fine-tuning/jobs/{job_id}" }],
  },
  {
    method: "POST",
    path: "/v1/fine-tuning/jobs/{job_id}/cancel",
    endpoint: "/v1/fine-tuning/jobs/{job_id}/cancel",
    code: MODEL_GATEWAY_ENDPOINT_UNSUPPORTED_CODE,
    reason: OPENAI_ENDPOINT_UNSUPPORTED_REASON,
    httpRoutes: [
      {
  ...
  },
  {
    ...
    code: MODEL_GATEWAY_ENDPOINT_UNSUPPORTED_CODE,
    reason: OPENAI_ENDPOINT_UNSUPPORTED_REASON,
    httpRoutes: [{ method: "GET", path: "/v1/vector_stores/:vectorStoreId", endpoint: "/v1/vector_stores/{vector_store_id}" }],
  },
  {
    method: "POST",
    path: "/v1/videos",
