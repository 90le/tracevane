...
const TERMINAL_ACTION_CATALOG: TerminalActionGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        labelZh: "前端覆盖清单",
        labelEn: "Frontend Coverage",
        descriptionZh: "输出 Aurora 前端路由、原型片段与运行面清单。",
        descriptionEn: "Inspect Aurora frontend routes, prototype fragments, and runtime surfaces.",
        command: "npm run tracevane:frontend-coverage",
        recommendedTitle: "前端覆盖",
        runMode: "new-session",
      },
    ],
  },
