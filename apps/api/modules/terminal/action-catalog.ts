    ...
    items: [
      {
        ...
        descriptionZh: "检查 Studio 运行状态与关键依赖。",
        descriptionEn: "Inspect Studio runtime health and key dependencies.",
      ...
      },
      {
        ...
        command: "npm run studio:terminal-workspace-coverage",
    ...
    items: [
      {
        ...
        command: "npm run studio:inventory",
