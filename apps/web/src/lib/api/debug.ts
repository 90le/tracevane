...
export function evaluateDebugSession(payload: DebugEvaluateRequest): Promise<DebugEvaluatePayload> {
  return apiRequest<DebugEvaluatePayload>(`${DEBUG_API_BASE}/sessions/evaluate`, {
    method: "POST",
    body: JSON.stringify(payload),
  });
}
