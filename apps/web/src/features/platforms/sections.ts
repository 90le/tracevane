...
export const OPENCLAW_SECTIONS: OpenClawSection[] = [
  ...
  { id: "agents", label: "原生 Agent", description: "OpenClaw 上游原生 Agent 定义证据；不是 Tracevane CLI Agents 运行台。", path: "/platforms/openclaw/agents" },
  { id: "channels", label: "原生渠道", description: "OpenClaw 上游原生 Channel 配置摘要；不是 Tracevane IM 渠道账号/投递配置。", path: "/platforms/openclaw/channels" },
  { id: "bindings", label: "原生绑定", description: "OpenClaw 上游 Channel 到 Agent/ACP 的静态绑定证据；不是 Tracevane IM 路由绑定。", path: "/platforms/openclaw/bindings" },
