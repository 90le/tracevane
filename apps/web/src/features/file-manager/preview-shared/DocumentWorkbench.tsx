...
} from "@/features/file-manager/code-editor/CodeEditor";
import {
  DocumentPreview,
...
export function DocumentWorkbench({
  ...
  React.useEffect(() => {
    window.dispatchEvent(
      new CustomEvent("tracevane:code-editor-search-state", {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener(
      "tracevane:code-editor-open-search",
      onOpenSearch,
    );
    window.addEventListener(
      "tracevane:code-editor-toggle-search",
      onToggleSearch,
    );
    window.addEventListener("tracevane:code-editor-zoom", onZoom);
    return () => {
      ...
      window.removeEventListener("tracevane:code-editor-zoom", onZoom);
    };
