...
- IDE Workbench layout / IDE Editor Foundation: `04-独立IDE工作台方案.md`, `05-前端实现方案.md`, `09-IDE参考行为与术语对照.md`, and `archive/m5y-a-ide-editor-foundation-plan.md` once present.
