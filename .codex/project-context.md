...
- Terminal / LSP / Git / Debug: `07-终端运行语言服务Git方案.md`, `06-后端服务与接口方案.md`, `08`, and `archive/m7-a-lsp-git-debug-plan.md` / `archive/m7-b-lsp-diagnostics-summary.md` / `archive/m7-c-lsp-interaction-summary.md` / `archive/m7-d-git-status-source-control-summary.md` / `archive/m7-e-a-git-diff-foundation-summary.md` / `archive/m7-e-b-git-stage-unstage-summary.md`.
