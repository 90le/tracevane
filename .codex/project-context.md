...
M13-I completed the product pivot decision. P0-A automated mainline validation baseline, P0-B gap audit, P1-A hardening plan, and P1-A-1 stale copy cleanup are complete. Current recommended next stage: P1 TS/JS Web Stack Experience Hardening.
...
- Done: M11-F-B external language server gateway skeleton guarded implementation.
- Done: M11-F-C first real external language server provider proof.
- Done: M11-F-D external provider lifecycle/status hardening and acceptance closeout.
- Done: M11-G external provider expansion and IDE status UI plan.
- Done: M11-H IDE external provider status UI foundation.
- Done: M11-I Bash external provider proof.
- Done: M11-J External provider installer/version policy plan.
...
- Done: M11-S ESLint external provider project-config/runtime safety plan.
- Done: M11-T ESLint external provider guarded diagnostics implementation.
...
- Done: M12-B Vue / Svelte framework provider guarded proof plan.
- Done: M12-C Vue external provider guarded diagnostics proof.
- Done: M12-D Svelte dependency compatibility / TypeScript peer policy plan.
- Done: M12-E Svelte external provider guarded diagnostics proof.
- Done: M12-F Framework provider acceptance / heavy toolchain policy decision.
- Done: M12-G Toolchain provider status / configuration foundation plan.
- Done: M12-H Toolchain provider status skeleton guarded implementation.
- Done: M12-I Toolchain provider configuration / trust UI foundation.
- Done: M12-J Go / gopls toolchain provider runtime proof plan.
- Done: M12-K Go / gopls guarded runtime proof.
- Done: M12-L Toolchain provider acceptance / next toolchain decision.
- Done: M12-M Rust / rust-analyzer runtime proof plan.
- Done: M12-N Rust / rust-analyzer guarded diagnostics proof.
- Done: M12-O Toolchain provider acceptance / next heavy provider decision.
- Done: M12-P C/C++ / clangd runtime proof plan.
- Done: M12-Q C/C++ / clangd guarded diagnostics proof.
- Done: M12-R Toolchain provider acceptance / Java JDT LS decision.
- Done: M12-S Java / Eclipse JDT LS runtime proof plan.
...
- Done: M13-E Go / gopls Hover + Definition Guarded Implementation.
...
- Done: M13-I Toolchain Rich Interaction Acceptance / Product Pivot Decision.
- Done: P0-A Remote Code Editing Mainline Validation Baseline.
- Done: P0-B Mainline Gap Audit.
- Done: P1-A Mainline UX Hardening Plan.
...
- Done: P1-A-5 Persistence / terminal clipboard checklist.
- Next: P1 TS/JS Web Stack Experience Hardening.
...
- Terminal / LSP / Git / Debug: `07-终端运行语言服务Git方案.md`, `06-后端服务与接口方案.md`, `08`, and `archive/m7-a-lsp-git-debug-plan.md` / `archive/m7-b-lsp-diagnostics-summary.md` / `archive/m7-c-lsp-interaction-summary.md` / `archive/m7-d-git-status-source-control-summary.md` / `archive/m7-e-a-git-diff-foundation-summary.md` / `archive/m7-e-b-git-stage-unstage-summary.md` / `archive/m7-e-c-git-commit-foundation-summary.md` / `archive/m7-e-d-git-branch-upstream-summary.md` / `archive/m7-git-execution-summary.md` / `archive/m7-f-a-debug-adapter-plan.md` / `archive/m7-f-b-debug-foundation-summary.md` / `archive/m7-f-c-debug-breakpoints-summary.md` / `archive/m7-f-d-debug-adapter-proof-summary.md` / `archive/m7-f-debug-execution-summary.md` / `archive/m7x-a-debug-hardening-plan.md` / `archive/m7x-b-debug-lifecycle-summary.md` / `archive/m7x-c-debug-launch-profile-summary.md` / `archive/m7x-d-debug-node-inspector-summary.md` / `archive/m7x-e-debug-controls-scopes-summary.md` / `archive/m7x-f-debug-watch-evaluate-summary.md` / `archive/m7x-debug-hardening-execution-summary.md` / `archive/m7y-a-lsp-git-debug-integration-plan.md` / `archive/m7y-b-typescript-javascript-lsp-diagnostics-summary.md` / `archive/m7y-c-typescript-javascript-lsp-interaction-plan.md` / `archive/m7y-d-typescript-javascript-hover-definition-summary.md` / `archive/m7y-e-typescript-javascript-completion-summary.md` / `archive/m7y-f-lsp-interaction-acceptance-summary.md` / `archive/m7z-a-lsp-git-debug-enhancement-plan.md` / `archive/m7z-b-lsp-references-summary.md` / `archive/m7z-c-lsp-rename-format-code-actions-plan.md` / `archive/m7z-d-git-remote-operations-plan.md` / `archive/m7z-e-git-remote-foundation-summary.md` / `archive/m7z-f-lsp-workspace-edit-summary.md` / `archive/m7z-g-lsp-rename-format-code-actions-summary.md` / `archive/m7z-h-git-branch-stash-ui-summary.md` / `archive/m7z-i-git-branch-stash-hardening-summary.md` / `archive/m7z-j-lsp-git-debug-enhancement-acceptance-summary.md` / `archive/m8-a-ide-stabilization-rc-plan.md` / `archive/m8-b-rc-smoke-matrix-runner-summary.md` / `archive/m8-c-rc-quick-gate-summary.md` / `archive/m8-d-full-domain-rc-matrix-summary.md` / `archive/m8-e-rc-acceptance-baseline-summary.md` / `archive/m8-f-rc-release-checklist-summary.md` / `archive/m8-g-rc-signoff-handoff-summary.md` / `archive/m9-a-post-m8-roadmap-branch-hygiene-plan.md` / `archive/m9-b-git-branch-management-safety-plan.md` / `archive/m9-c-git-branch-management-guarded-implementation-summary.md` / `archive/m9-d-git-graph-blame-readonly-summary.md` / `archive/m10-a-lsp-semantic-tokens-workspace-symbols-plan.md` / `archive/m10-b-lsp-semantic-tokens-summary.md` / `archive/m10-c-lsp-workspace-symbols-summary.md` / `archive/m10-d-lsp-semantic-workspace-symbols-acceptance-summary.md` / `archive/m11-a-post-m10-ide-intelligence-roadmap-plan.md` / `archive/m11-b-command-palette-go-to-symbol-summary.md` / `archive/m11-c-watcher-backed-symbol-index-plan.md` / `archive/m11-c-b-watcher-backed-symbol-index-summary.md` / `archive/m11-d-multi-language-lsp-provider-plan.md` / `archive/m11-e-a-provider-registry-summary.md` / `archive/m11-e-b-json-language-service-summary.md` / `archive/m11-e-c-html-css-language-services-summary.md` / `archive/m11-f-a-external-language-server-gateway-plan.md` / `archive/m11-f-b-external-lsp-gateway-skeleton-summary.md` / `archive/m11-f-c-yaml-external-provider-proof-summary.md` / `archive/m11-f-d-external-provider-lifecycle-status-summary.md` / `archive/m11-g-external-provider-expansion-status-ui-plan.md` / `archive/m11-h-ide-external-provider-status-ui-summary.md` / `archive/m11-i-bash-external-provider-proof-summary.md` / `archive/m11-j-external-provider-installer-version-policy-plan.md` / `archive/m11-k-external-provider-optional-status-summary.md` / `archive/m11-l-external-provider-dependency-hygiene-summary.md` / `archive/m11-m-pyright-external-provider-plan.md` / `archive/m11-n-pyright-external-provider-summary.md` / `archive/m11-o-external-provider-acceptance-expansion-decision.md` / `archive/m11-p-dockerfile-external-provider-summary.md` / `archive/m11-q-markdown-vscode-langservers-extracted-plan.md` / `archive/m11-r-markdown-external-provider-summary.md` / `archive/m11-s-eslint-external-provider-safety-plan.md` / `archive/m11-t-eslint-external-provider-summary.md` / `archive/m11-u-eslint-workingdirectories-hardening-plan.md` / `archive/m11-v-eslint-workingdirectories-summary.md` / `archive/m12-c-vue-external-provider-summary.md` / `archive/m12-d-svelte-typescript-peer-policy-plan.md` / `archive/m12-e-svelte-external-provider-summary.md` / `archive/m12-f-framework-provider-acceptance-toolchain-policy.md` / `archive/m12-g-toolchain-provider-status-configuration-plan.md` / `archive/m12-h-toolchain-provider-status-skeleton-summary.md` / `archive/m12-i-toolchain-provider-configuration-trust-summary.md` / `archive/m12-j-go-gopls-runtime-proof-plan.md` / `archive/m12-k-go-gopls-guarded-runtime-summary.md` / `archive/m12-l-toolchain-provider-acceptance-decision.md` / `archive/m12-m-rust-analyzer-runtime-proof-plan.md` / `archive/m12-n-rust-analyzer-guarded-runtime-summary.md` / `archive/m12-o-toolchain-provider-acceptance-decision.md` / `archive/m12-p-clangd-runtime-proof-plan.md` / `archive/m12-q-clangd-guarded-runtime-summary.md` / `archive/m12-r-toolchain-provider-acceptance-java-decision.md` / `archive/m12-s-java-jdtls-runtime-proof-plan.md` / `archive/m12-t-java-jdtls-guarded-runtime-summary.md` / `archive/m12-u-toolchain-provider-acceptance-closeout.md` / `archive/m13-a-toolchain-post-diagnostics-roadmap-plan.md` / `archive/m13-b-toolchain-provider-status-guidance-summary.md` / `archive/m13-c-single-provider-rich-interaction-decision.md` / `archive/m13-d-go-gopls-hover-definition-plan.md` / `archive/m13-e-go-gopls-hover-definition-summary.md` / `archive/m13-f-toolchain-rich-interaction-acceptance-decision.md` / `archive/m13-g-rust-analyzer-hover-definition-plan.md` / `archive/m13-h-rust-analyzer-hover-definition-summary.md` / `archive/m13-i-toolchain-rich-interaction-product-pivot-summary.md` / `archive/p0-remote-code-editing-mainline-audit-plan.md` / `archive/p0-a-mainline-validation-baseline-summary.md` / `archive/p0-b-mainline-gap-audit-summary.md` / `archive/p1-a-mainline-ux-hardening-plan.md` / `archive/p1-a-1-stale-copy-cleanup-summary.md` / `archive/p1-a-2-explorer-mainline-summary.md`.
