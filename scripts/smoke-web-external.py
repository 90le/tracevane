#!/usr/bin/env python3
"""Browser smoke for the rebuilt apps/web External Connections (/external).

Loads each External Connections data-view at desktop + mobile widths against
the dev server, captures console errors / uncaught page errors, and checks for
horizontal overflow. Exits non-zero on any failure.

Usage: python3 scripts/smoke-web-external.py [--base http://127.0.0.1:5176]
"""
import sys
...
VIEWS = ["overview", "connections", "capabilities", "auth"]
