...
- M6 watcher/search/problems/output foundations are complete; M7-A/M7-B/M7-C LSP foundation, M7-D Git status visibility, M7-E-A Git diff viewing, M7-E-B stage/unstage and M7-E-C commit are complete. Any M7-E-D Git follow-up must reuse existing Git API/service and avoid push/pull/merge/rebase/stash/Git graph/Debug unless opened as a separate stage.
