...
test("file manager routes files through unified online surface", () => {
  ...
  const fileSurfacePanel = read("apps/web/src/shared/file-surface/FileSurfacePreviewPanel.tsx");
  assert.match(fileSurfacePanel, /data-file-surface-panel/);
  assert.match(fileSurfacePanel, /data-file-surface-image/);
  assert.match(fileSurfacePanel, /data-file-surface-image-canvas/);
  assert.match(fileSurfacePanel, /data-file-surface-image-zoom-in/);
  assert.match(fileSurfacePanel, /data-file-surface-video/);
  assert.match(fileSurfacePanel, /data-file-surface-video-speed/);
  assert.match(fileSurfacePanel, /data-file-surface-audio/);
  assert.match(fileSurfacePanel, /data-file-surface-audio-speed/);
  assert.match(fileSurfacePanel, /data-file-surface-pdf/);
  assert.match(fileSurfacePanel, /data-file-surface-binary/);
