...
test("channels workspace layout keeps a provider/account stage with a top task bar", () => {
  assert.match(workspaceLayout, /class="channels-workbench tracevane-workbench tracevane-workbench--object"/);
  assert.match(
    workspaceLayout,
    /class="channels-sidebar operate-resource-rail mobile-resource-drawer tracevane-workbench-index"/,
  );
  assert.match(workspaceLayout, /class="channels-stage operate-stage tracevane-workbench-canvas"/);
  assert.match(workspaceLayout, /class="channels-task-bar tracevane-workbench-task-bar"/);
  assert.match(workspaceLayout, /class="channels-task-canvas tracevane-workbench-active-canvas"/);
  assert.match(workspaceLayout, /class="channels-task-nav tracevane-workbench-task-nav"/);
  assert.doesNotMatch(workspaceLayout, /channels-task-rail|tracevane-workbench-task-rail/);
