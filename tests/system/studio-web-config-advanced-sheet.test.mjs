...
test('config advanced sheet uses a visible modal layer above the page chrome', () => {
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet-mask\s*\{[\s\S]*position:\s*fixed;/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet-mask\s*\{[\s\S]*z-index:\s*3100;/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet-mask\s*\{[\s\S]*display:\s*grid;/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet-mask\s*\{[\s\S]*place-items:\s*center;/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet\s*\{[\s\S]*position:\s*fixed;/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet\s*\{[\s\S]*top:\s*50%;/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet\s*\{[\s\S]*left:\s*50%;/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet\s*\{[\s\S]*transform:\s*translate\(-50%,\s*-50%\);/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet\s*\{[\s\S]*z-index:\s*3101;/);
});
...
test('config advanced sheet carries the resolved theme so light mode gets its own surfaced dialog treatment', () => {
  ...
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet-mask\.theme-light\s*\{/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet\.theme-light\s*\{/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet-mask\.theme-dark\s*\{/);
  assert.match(configAdvancedSheet, /\.config-domain-advanced-sheet\.theme-dark\s*\{/);
});
