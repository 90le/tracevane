...
test("new Workspace IDE shell exposes a visual pane layout manager", () => {
  ...
  assert.match(shellSource, /data-ide-pane-layout-dock-snapshot=\{snapshot\.id\}/);
  assert.match(shellSource, /data-ide-pane-layout-dock-snapshot-placement=\{snapshot\.placement\}/);
  assert.match(shellSource, /data-ide-pane-layout-dock-snapshot-restore=\{snapshot\.id\}/);
  assert.match(shellSource, /data-ide-pane-layout-dock-snapshot-update=\{snapshot\.id\}/);
  assert.match(shellSource, /data-ide-pane-layout-dock-snapshot-delete=\{snapshot\.id\}/);
...
test("new Workspace IDE shell exposes a mobile dock rail inside the pane layout manager", () => {
  ...
  assert.match(shellSource, /data-ide-pane-layout-mobile-open=\{open\[placement\] \? "true" : "false"\}/);
