...
test("channels workspace keeps a persistent provider/account tree and top task bar", () => {
  ...
  assert.match(channelsWorkspaceLayout, /class="channels-task-nav tracevane-workbench-task-nav"/);
  assert.match(channelsWorkspaceLayout, /class="channels-task-nav-button tracevane-workbench-task-nav-button"/);
  assert.match(channelsWorkspaceLayout, /class="channels-task-bar tracevane-workbench-task-bar"/);
  assert.doesNotMatch(channelsWorkspaceLayout, /channels-task-rail|tracevane-workbench-task-rail/);
