...
test("Channel Connector profiles page edits profiles using Gateway model catalog", () => {
  ...
  assert.match(page, /ccx-agent-profile-activity-section/);
  assert.match(page, /Persistent requests|持久请求/);
  assert.match(page, /Active sessions|活动会话/);
  assert.match(page, /Event log|事件日志/);
  assert.match(page, /ccx-agent-profile-row-pills/);
  assert.match(page, /ccx-agent-profile-trace-details/);
  ...
  assert.match(page, /ccx-agent-profile-event-summary/);
  assert.match(page, /ccx-agent-profile-event-side/);
  assert.match(page, /ccx-agent-profile-event-badge/);
  assert.match(page, /ccx-agent-profile-event-message/);
  ...
  assert.match(styles, /\.ccx-agent-profile-activity-section/);
  assert.match(styles, /\.ccx-agent-profile-activity-section__head/);
  assert.match(styles, /\.ccx-agent-profile-requested-list/);
  assert.match(styles, /\.ccx-agent-profile-requested-row/);
  assert.match(styles, /\.ccx-agent-profile-row-pills/);
  assert.match(styles, /\.ccx-agent-profile-trace-details/);
  assert.match(styles, /\.ccx-agent-profile-event-summary/);
  assert.match(styles, /\.ccx-agent-profile-event-side/);
  assert.match(styles, /\.ccx-agent-profile-event-badge/);
  assert.match(styles, /\.ccx-agent-profile-event-message/);
  ...
  assert.doesNotMatch(styles, /\.ccx-agent-profile-linked-row/);
