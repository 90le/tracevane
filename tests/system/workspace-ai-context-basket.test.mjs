...
test("Workspace AI context basket has a shared durable document item contract", () => {
  ...
  assert.match(basket, /export function subscribeWorkspaceAiContextBasket/);
  assert.match(basket, /export function removeWorkspaceAiContextBasketItem/);
  assert.match(basket, /export function clearWorkspaceAiContextBasket/);
  assert.match(basket, /export function replaceWorkspaceAiContextBasket/);
  ...
  assert.match(basket, /WorkspaceAiContextBasketAction/);
  assert.match(basket, /action: "add"/);
  assert.match(basket, /action: "remove"/);
  assert.match(basket, /action: "clear"/);
  assert.match(basket, /action: "replace"/);
  assert.match(basket, /window\.addEventListener\(TRACEVANE_WORKSPACE_AI_CONTEXT_BASKET_EVENT/);
  assert.match(basket, /window\.removeEventListener/);
