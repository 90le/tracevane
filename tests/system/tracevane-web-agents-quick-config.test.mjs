...
test("agents polish keeps mobile action groups stacked for thumb reach", () => {
  ...
  assert.match(agentsWorkspaceLayoutContent, /class="agents-task-nav tracevane-workbench-task-nav"/);
  assert.match(agentsWorkspaceLayoutContent, /class="agents-task-nav-button tracevane-workbench-task-nav-button"/);
