...
test("terminal resource explorer opens IDE-style editable file previews", () => {
  ...
  assert.match(terminalFilePreviewPane, /type TerminalFilePreviewMode = 'edit' \| 'preview' \| 'split'/);
  ...
  assert.match(terminalFilePreviewPane, /state\.previewMode = 'split';/);
  ...
  assert.match(terminalFilePreviewPane, /分屏同步预览/);
  assert.match(terminalFilePreviewPane, /terminal-file-preview__split--markdown/);
  assert.match(terminalFilePreviewPane, /ref="markdownSplitRef"/);
  assert.match(terminalFilePreviewPane, /function scheduleMarkdownSplitScrollBinding\(attempt = 0\): void/);
  assert.match(terminalFilePreviewPane, /function bindMarkdownSplitScroll\(editorScroller: HTMLElement, previewScroller: HTMLElement\): void/);
  assert.match(terminalFilePreviewPane, /function syncMarkdownScrollRatio\(source: HTMLElement, target: HTMLElement\): void/);
  assert.match(terminalFilePreviewPane, /clearMarkdownSplitScrollBinding\(\);/);
  ...
  assert.match(workspaceCss, /\.terminal-file-preview__split\s*\{[\s\S]*grid-template-columns:\s*minmax\(0,\s*1fr\) minmax\(320px,\s*1fr\);/);
