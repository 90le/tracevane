...
test("Tracevane Gateway page keeps provider configuration user-owned", () => {
  ...
  for (const expected of [
    ...
    "Disable auth",
    "clientAuthReveal",
    "appConnectionClientKeyReady",
    "appConnectionClientKeyIssue",
    "appConnectionIssueLabel",
    "guardAppConnectionClientKey",
    "prepareClientKeyForAppConnections",
    "生成并启用 key",
    "手动编辑 key",
    "Gateway key 已保存但未启用",
    "mgw-client-key-required",
    "mgw-client-key-inline",
    ...
    "providerSecretVisible",
    "providerApiKeyForProbe",
    "revealProviderSecretForEdit",
    "已保存的密钥会自动载入",
    "mgw-runtime-more",
    "mgw-detect-popover",
    "mgw-detect-card",
    "applyDetectedProtocol",
    "detectedModelSelection",
    "detectedModelSelectionSummary",
    "seedDetectedModelSelection",
    "importSelectedDetectedModels",
    "模型候选",
    "导入所选模型",
    "选择当前可见",
    "modelRowsVisibleLimit",
    "visibleDraftModelRowEntries",
    "hiddenDraftModelRowCount",
    "visibleDetectedCandidateModels.value",
